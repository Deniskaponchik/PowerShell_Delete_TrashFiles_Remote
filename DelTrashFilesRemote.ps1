...
$Oth8 = "Если устройство позволяет, то добавить диск $ActualSsdSize и ОБЯЗАТЕЛЬНО установить $ActualWindowsVersion", 'Очистить потом диск C: не менее чем на 150 ГБ, переносом пользовательской информации на новый диск', "Если места для установки второго диска нет, то просто заменить на SSD 500 ГБ и установить $ActualWindowsVersion"
...
#$Oth10 = "Необходимо полностью заменить устаревший ноутбук. $Proc"
 $Oth16 = "Заменить SSD на больший объём = 240 ГБ", 'Старый SSD-диск передать логисту на склад', "Уже далеко не первая заявка на очистку диска", '', "На основании тикета System Monitoring Auto Create: $Ticket", ''
